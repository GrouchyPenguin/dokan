 ...
 * @return \WP_Query
 */
function dokan_get_featured_products( $per_page = 13, $seller_id = '', $page = 1 ) {
 ...
 * @return \WP_Query
 */
function dokan_get_latest_products( $per_page = 12, $seller_id = '', $page = 1 ) {
 ...
 * @return \WP_Query
 */
function dokan_get_best_selling_products( $per_page = 12, $seller_id = '', $page = 1, $hide_outofstock = false ) {
    $args = array(
        'post_type'           => 'product',
        'post_status'         => 'publish',
        'ignore_sticky_posts' => 1,
 ...
 * @return \WP_Query
 */
function dokan_get_top_rated_products( $per_page = 12, $seller_id = '', $page = 1 ) {
...
function dokan_get_more_products_from_seller( $seller_id = 0, $posts_per_page = 6 ) {
    ...
    if ( $products->have_posts() ) {
        ...
        esc_html_e( 'No products have been found!', 'dokan-lite' );
    }
